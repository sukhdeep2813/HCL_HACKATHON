...
const Button = ({
  ...
  return (
    <button
      ...
      className={clsx(
        'inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-200 focus-visible:outline-2 disabled:cursor-not-allowed disabled:opacity-60',
